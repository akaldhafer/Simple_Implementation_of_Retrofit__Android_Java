...
public class MainActivity extends AppCompatActivity {
    ...
    private void createPost(){
        Post post = new Post(99, "New Post", "New text");
        Call<Post> call =jsonPlaceHolderApi.createPost(98, "New Post", "New text");
    ...
    private void updatePost(){
        Post post= new Post(12, "new title", "test");

        Map<String, String> headers =new HashMap<>();
        headers.put("Map-Header1","test1");
        headers.put("Map-Header2","test2");
